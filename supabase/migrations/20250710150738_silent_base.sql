...
BEGIN
  ...
  IF NEW.status = 'approved' AND OLD.status = 'pending' THEN
    ...
    SELECT w.user_id, w.tokens, w.token_type_id INTO wallet_user_id, user_tokens, token_type_id
    FROM user_wallets w
    ...
    IF wallet_user_id IS NULL THEN
      ...
      RETURNING user_id, tokens, token_type_id INTO wallet_user_id, user_tokens, token_type_id;
    END IF;
