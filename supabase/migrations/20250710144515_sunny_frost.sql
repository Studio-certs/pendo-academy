/*
  ...
  1. Changes
    - Update handle_application_approval function to properly handle token deduction
    - Fix the enrollment creation process
    - Add proper error handling and transaction management
    - Ensure application_id is properly set in course_enrollments
