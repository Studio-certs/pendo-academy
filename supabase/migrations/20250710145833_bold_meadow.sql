/*
  # Fix Application Approval Process

  1. Changes
    - Drop existing trigger and function
    - Create improved handle_application_approval function
    - Add proper transaction handling
    - Add detailed error messages
    - Add token deduction and transaction recording
    - Create course enrollment with application_id reference
